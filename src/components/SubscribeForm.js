...
const mailChimpHtml = "<div style='background: antiquewhite;' id=\"mc_embed_signup\">\n" +
    ...
    "    <div class=\"clear\"><input style='background-color: #3e3430;' type=\"submit\" value=\"Subscribe\" name=\"subscribe\" id=\"mc-embedded-subscribe\" class=\"button\"></div>\n" +
    "    </div>\n" +
    "</form>\n" +
    "</div>\n" +
    "\n" +
...
const SubscribeForm = function(){
    return <div dangerouslySetInnerHTML={{ __html: mailChimpHtml }} />;
}
