...
const FeatureTemplate = function (props) {
  ...
  return (
    ...
    >
      <div
        className={`max-w-screen-xl pt-16 pb-16 flex flex-col lg:${flexDirection} items-start`}
      >
        <div className="flex flex-col justify-center items-center py-10 lg:w-4/6 lg:px-10">
          ...
          <p className="text-xl tracking-wide text-center pt-10 leading-8">
            {description}
          </p>
      ...
      <div className="lg:flex-row-reverse"></div>
      <div></div>
    </div>
  );
};
